 ...
 * Non-sync version of above, which copies instead of writes.
 */
...
function copyFileRecursive(source, filename, callback) {
	...
	// -- write file
	fs.copyFile(source, root + filepath, callback)
}

module.exports = copyFileRecursive
